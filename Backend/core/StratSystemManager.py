...
#||=========================================================================================||
    ...
    def _default_rank(self, step_dt, hierarchy: dict, indicator_pool: dict, sim_data: dict, port_returns: dict, key) -> Dict[str, float]:
        return hierarchy, indicator_pool, sim_data, port_returns

    def _default_filter(self, step_dt, hierarchy: dict, indicator_pool: dict, sim_data: dict, port_returns: dict, key) -> List[str]:
        return hierarchy, indicator_pool, sim_data, port_returns # By default doesn't filter out any model

    def _default_rebalance(self, step_dt, hierarchy: dict, indicator_pool: dict, sim_data: dict, port_returns: dict, key) -> List[str]:
        return hierarchy, indicator_pool, sim_data, port_returns
